...
def fSymbols():
  ...
  for vPath in [*sorted((cRoot / 'Scripts/macos_iso').glob('*.py')),
                cRoot / 'mcOSisoCreator.py', cRoot / 'Scripts/package_macos_iso.py']:
...
def fMain():
  ...
  vParser.add_argument('--destination', type=Path, default=cRoot / 'Releases/mcOSisoCreator', dest='vDestination')
  ...
  vLauncherPath = cRoot / 'mcOSisoCreator.py'
